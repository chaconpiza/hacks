...
#def keystone_data(user_name='monasca-agent', user_password='password', project_name='mini-mon'):
#def keystone_data(user_name='admin', user_password='secretadmin', project_name='admin'):
#def keystone_data(user_name='demo', user_password='secretadmin', project_name='demo'):
...
def set_event(token, event_type, tenant_id):
    r = requests.post(
        ...
        #params={"tenant_id":"a119e84c72ef4f0f831b95ae4afea2e6"}
        params={"tenant_id":"77fe41e2670e40b4b0dcdc83df061eaa"}
        #params={"tenant_id":"77fe41e2670e40b4b111111111111111"}
        )
